...
export default function Wardrobe({ userId, tripId, onClose, onDragStart, onDragEnd, isReadOnly, isSettingsMode }: WardrobeProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      {!isSettingsMode && (
        <AnimatePresence>
          {selectedItems.length > 0 && (
            <View style={styles.bunchWrapper} pointerEvents="box-none">
              ...
              <GestureDetector gesture={panGesture}>
                <Animated.View style={[styles.bunchContainer, animatedBunchStyle]}>
      ...
      {/* Detail Modals (Shortened for brevity) */}
      <AnimatePresence>
        {viewingItem && (
...
const styles = StyleSheet.create({
  ...
  bunchWrapper: { position: 'absolute', bottom: 40, left: 0, right: 0, alignItems: 'center', zIndex: 1000 },
